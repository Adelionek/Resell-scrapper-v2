ALLEGRO_PAGES = {
    ...
    'newBalance_M': 'https://allegro.pl/kategoria/meskie-sportowe-257929?dostawa-z-polski=tak&marka=New%20'
                    ...
                    'match=dict20120-m-ctx-fas-1-2-1203&order=n',
    'newBalance_W': 'https://allegro.pl/kategoria/obuwie-damskie-531?order=n&bmatch=nbn-e2101-d3681-c3682-fas-1-2-0319'
                    '&stan=nowe&marka=New%20Balance&oryginalne-opakowanie-producenta=pude%C5%82ko&'
                    'dostawa-z-polski=tak&freeReturn=1',
    ...
    'reebok_W': 'https://allegro.pl/kategoria/damskie-sportowe-257903?stan=nowe&oryginalne-opakowanie-producenta='
                'pude%C5%82ko&dostawa-z-polski=tak&freeReturn=1&marka=Reebok&'
                'order=n&bmatch=nbn-e2101-d3681-c3682-fas-1-2-0319'
}
